...
MODEL              = Rad
MODULES            = Rad_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = Rad.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Users\os.alsaidi\Desktop\Lokal\Lehre\Fahrzeugregelung\WS1617\03_Projektaufgabe\01_Organisation\Projekt_ESP_WiSe1617
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = ode1.c
NUMST              = 2
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=Radlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f "C:\Users\os.alsaidi\AppData\Roaming\MathWorks\MATLAB\R2015a\mex_C_win64.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Rad_sfcn_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\os.alsaidi\Desktop\Lokal\Lehre\Fahrzeugregelung\WS1617\03_Projektaufgabe\03_Lösung
