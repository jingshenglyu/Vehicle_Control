...
%
%   $Id: crg_check_mods.m 335 2013-12-13 15:57:58Z jorauh $
...
if isfield(data.mods, 'gnao')
    ...
    if data.mods.gnan == 0 % check for useless offset setting
        error('CRG:checkError', 'inconsistent DATA.mods.gnan=%d and DATA.mods.gano=%d', data.mods.gnan, data.mods.gnao)
    end
end
