...
%
%   $Id: crg_wgs84_crg2html.m 331 2013-10-15 17:18:12Z jorauh $
...
m_opts.beg_pu = [ ...
    ...
    '  <tr><td>X =</td><td>' num2str(data.head.xbeg, '%.3f') '</td><td></td><td>lon =</td><td>' num2str(data.head.nbeg, '%.6f') '</td></tr>' ...
    '  <tr><td>Y =</td><td>' num2str(data.head.ybeg, '%.3f') '</td><td></td><td>lat =</td><td>' num2str(data.head.ebeg, '%.6f') '</td></tr>' ...
    ];
...
m_opts.end_pu  = [ ...
    ...
    '  <tr><td>V =</td><td>' num2str(             0, '%.3f') '</td></tr>' ...
    '  <tr><td>X =</td><td>' num2str(data.head.xend, '%.3f') '</td><td></td><td>lon =</td><td>' num2str(data.head.nend, '%.6f') '</td></tr>' ...
    '  <tr><td>Y =</td><td>' num2str(data.head.yend, '%.3f') '</td><td></td><td>lat =</td><td>' num2str(data.head.eend, '%.6f') '</td></tr>' ...
    ];
if isfield(data.head, 'abeg')
